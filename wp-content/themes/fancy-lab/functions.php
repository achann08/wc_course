...
function fancy_lab_scripts(){
	...
	wp_enqueue_script('flexslider-min-js', get_template_directory_uri() . '/inc/flexslider/jquery.flexslider.js', array('jquery'), '', true);
...
function fancy_lab_sidebars(){
	register_sidebar(array(
		...
		'description' 	=> esc_html__('Drag and drop your widget here', 'fancy-lab'),
